...
import { DocumentUnifyModel, DocumentUnifyResponseModel } from '../documentunify';
...
@Component({
    templateUrl: './detaildocumentunify.component.html',
    providers: [
...
export class DetailDocUnifyComponent implements OnInit {
    ...
    responseModel: DocumentUnifyResponseModel = {};
